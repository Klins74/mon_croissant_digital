...
const ContactMultiChannelSupport = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Контакты и поддержка - FrenchCroissant Digital | Многоканальная служба поддержки</title>
        <meta 
          name="description" 
        ...
        <meta property="og:title" content="Контакты и поддержка - FrenchCroissant Digital" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-heading font-bold">FrenchCroissant Digital</h3>
...
© {new Date()?.getFullYear()} FrenchCroissant Digital. Все права защищены. | Халяль сертификат | Премиум французская пекарня
              </p>
            </div>
          </div>
        </footer>
