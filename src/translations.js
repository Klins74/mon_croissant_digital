const translations = {
  ru: {
    ...
    heritage: {
      ...
      storyText: "Рожденный из страсти к аутентичной французской выпечке и глубокого уважения к местным традициям, MonCroissant соединяет два мира. Наши мастера-пекари, обученные в Лионе и Париже, приносят вековые техники в Казахстан, соблюдая халяльные принципы и местные вкусы.\n\nКаждый рецепт рассказывает историю культурной гармонии - от наших масляных круассанов из премиального халяльного масла до пан-о-шокола из бельгийского шоколада, соответствующего исламским диетическим законам.",
  ...
  en: {
    ...
    heritage: {
      ...
      storyText: "Born from a passion for authentic French baking and deep respect for local traditions, MonCroissant bridges two worlds. Our master bakers trained in Lyon and Paris bring centuries-old techniques to Kazakhstan, while honoring halal principles and local tastes.\n\nEvery recipe tells a story of cultural harmony - from our buttery croissants made with premium halal butter to our pain au chocolat crafted with Belgian chocolate that meets Islamic dietary laws.",
